...
### v5 → v6（73 共同日期，2025-10 ~ 2026-04）
- T+3 胜率: v5 44.1% → v6 44.4% (+0.30pp)
- T+3 收益: v5 -0.23% → v6 -0.26% (-0.02%)
- 反弹期改善: 2025-12 +1.2pp，2026-02 +0.6pp
- 解读：筹码集中度因子在反弹期起作用，下跌期影响小；
  龙虎榜在历史回测中无效（akshare 只能拿当下数据），实盘价值更高
